...
// =================================================================
// Conteúdo histórico abaixo é todo baseado em fatos públicos e
// amplamente documentados sobre a história dos videogames.
// =================================================================
...
function Index() {
  ...
  useEffect(() => {
    ...
    if (missing > 0) {
      ...
      // re-sync once to fetch trailers via RAWG /movies endpoint
      triggered.current = true;
      sync.mutate(true);
    }
  }, [enriched, sync]);
            ...
            <div className="space-y-6">
              {TIMELINE.map((t, i) => (
                ...
                >
                  ...
                  <div className={`text-sm text-muted-foreground ${i % 2 === 0 ? "" : ""}`}>{t.event}</div>
        ...
        <section className="px-4 sm:px-6">
          <div className="relative overflow-hidden rounded-2xl border border-neon-purple/40 bg-gradient-to-br from-neon-purple/20 via-card to-neon-pink/15 p-8 sm:p-12 glow-purple">
            ...
            <div className="relative max-w-2xl space-y-4">
              ...
              <Link to="/discover" className="inline-flex items-center gap-2 px-6 h-11 rounded-md bg-foreground text-background font-semibold hover:bg-neon-cyan transition">
